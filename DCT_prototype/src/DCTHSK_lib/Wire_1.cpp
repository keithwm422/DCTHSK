...
uint8_t TwoWire_1::rxBuffer[BUFFER_LENGTH];
uint8_t TwoWire_1::rxReadIndex = 0;
uint8_t TwoWire_1::rxWriteIndex = 0;
uint8_t TwoWire_1::txAddress = 0;

uint8_t TwoWire_1::txBuffer[BUFFER_LENGTH];
uint8_t TwoWire_1::txReadIndex = 0;
uint8_t TwoWire_1::txWriteIndex = 0;

uint8_t TwoWire_1::transmitting = 0;
uint8_t TwoWire_1::currentState = IDLE;

void (*TwoWire_1::user_onRequest)(void);
void (*TwoWire_1::user_onReceive)(int);

uint8_t TwoWire_1::i2cModule = NOT_ACTIVE;
uint8_t TwoWire_1::slaveAddress = 0;
// Constructors ////////////////////////////////////////////////////////////////
...
TwoWire_1::TwoWire_1(unsigned long module)
{
	i2cModule = module;
}
...
uint8_t TwoWire_1::getError(uint8_t thrownError) {
...
uint8_t TwoWire_1::getRxData(unsigned long cmd) {
...
uint8_t TwoWire_1::sendTxData(unsigned long cmd, uint8_t data) {
    while(ROM_I2CMasterBusy(MASTER_BASE));
...
void TwoWire_1::begin(uint8_t address)
{
...
void TwoWire_1::begin(int address)
{
  begin((uint8_t)address);
}

uint8_t TwoWire_1::requestFrom(uint8_t address, uint8_t quantity, uint8_t sendStop)
{
  uint8_t error = 0;
...
uint8_t TwoWire_1::requestFrom(uint8_t address, uint8_t quantity)
{
  return requestFrom((uint8_t)address, (uint8_t)quantity, (uint8_t)true);
}
uint8_t TwoWire_1::requestFrom(int address, int quantity)
{
  return requestFrom((uint8_t)address, (uint8_t)quantity, (uint8_t)true);
}
uint8_t TwoWire_1::requestFrom(int address, int quantity, int sendStop)
{
  return requestFrom((uint8_t)address, (uint8_t)quantity, (uint8_t)sendStop);
}

void TwoWire_1::beginTransmission(uint8_t address)
{
  transmitting = 1;
...
void TwoWire_1::beginTransmission(int address)
{
  beginTransmission((uint8_t)address);
}

uint8_t TwoWire_1::endTransmission(uint8_t sendStop)
{
...
//
uint8_t TwoWire_1::endTransmission(void)
{
...
size_t TwoWire_1::write(uint8_t data)
{
  if(transmitting){
...
// slave tx event callback
// or after beginTransmission(address)
size_t TwoWire_1::write(const uint8_t *data, size_t quantity)
{
...
void TwoWire_1::onReceive( void (*function)(int) )
{
  user_onReceive = function;
}

// sets function called on slave read
void TwoWire_1::onRequest( void (*function)(void) )
{
  user_onRequest = function;
}

void TwoWire_1::I2CIntHandler(void) {
...
void
I2CIntHandler_1(void)
{
    Wire_1.I2CIntHandler();
}

void TwoWire_1::setModule(unsigned long _i2cModule)
{
