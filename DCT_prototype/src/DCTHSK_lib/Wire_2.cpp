...
uint8_t TwoWire_2::rxBuffer[BUFFER_LENGTH];
uint8_t TwoWire_2::rxReadIndex = 0;
uint8_t TwoWire_2::rxWriteIndex = 0;
uint8_t TwoWire_2::txAddress = 0;

uint8_t TwoWire_2::txBuffer[BUFFER_LENGTH];
uint8_t TwoWire_2::txReadIndex = 0;
uint8_t TwoWire_2::txWriteIndex = 0;

uint8_t TwoWire_2::transmitting = 0;
uint8_t TwoWire_2::currentState = IDLE;

void (*TwoWire_2::user_onRequest)(void);
void (*TwoWire_2::user_onReceive)(int);

uint8_t TwoWire_2::i2cModule = NOT_ACTIVE;
uint8_t TwoWire_2::slaveAddress = 0;
// Constructors ////////////////////////////////////////////////////////////////
...
TwoWire_2::TwoWire_2(unsigned long module)
{
	i2cModule = module;
}
...
uint8_t TwoWire_2::getError(uint8_t thrownError) {
...
uint8_t TwoWire_2::getRxData(unsigned long cmd) {
...
uint8_t TwoWire_2::sendTxData(unsigned long cmd, uint8_t data) {
    while(ROM_I2CMasterBusy(MASTER_BASE));
...
void TwoWire_2::begin(uint8_t address)
{
...
void TwoWire_2::begin(int address)
{
  begin((uint8_t)address);
}

uint8_t TwoWire_2::requestFrom(uint8_t address, uint8_t quantity, uint8_t sendStop)
{
  uint8_t error = 0;
...
uint8_t TwoWire_2::requestFrom(uint8_t address, uint8_t quantity)
{
  return requestFrom((uint8_t)address, (uint8_t)quantity, (uint8_t)true);
}
uint8_t TwoWire_2::requestFrom(int address, int quantity)
{
  return requestFrom((uint8_t)address, (uint8_t)quantity, (uint8_t)true);
}
uint8_t TwoWire_2::requestFrom(int address, int quantity, int sendStop)
{
  return requestFrom((uint8_t)address, (uint8_t)quantity, (uint8_t)sendStop);
}

void TwoWire_2::beginTransmission(uint8_t address)
{
  transmitting = 1;
...
void TwoWire_2::beginTransmission(int address)
{
  beginTransmission((uint8_t)address);
}

uint8_t TwoWire_2::endTransmission(uint8_t sendStop)
{
...
//
uint8_t TwoWire_2::endTransmission(void)
{
...
size_t TwoWire_2::write(uint8_t data)
{
  if(transmitting){
...
// slave tx event callback
// or after beginTransmission(address)
size_t TwoWire_2::write(const uint8_t *data, size_t quantity)
{
...
void TwoWire_2::onReceive( void (*function)(int) )
{
  user_onReceive = function;
}

// sets function called on slave read
void TwoWire_2::onRequest( void (*function)(void) )
{
  user_onRequest = function;
}

void TwoWire_2::I2CIntHandler(void) {
...
void
I2CIntHandler_2(void)
{
    Wire_2.I2CIntHandler();
}

void TwoWire_2::setModule(unsigned long _i2cModule)
{
